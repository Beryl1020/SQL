...
from info_silver.ods_crm_transfer_record trans
left join silver_njs.history_transfer@silver_std ab
...
tb_silver_user_stat@silver_std where to_char(open_account_time,'yyyymmdd') between 20170301 and 20170308 )
a
