...
select * from silver_consult.tb_crm_tel_record@consul_std where user_id=1201014 and worksec>0


SELECT *
FROM silver_consult.tb_crm_ia@consul_std   where name in ('朱慧敏')
